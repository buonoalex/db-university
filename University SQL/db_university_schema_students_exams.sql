...
CREATE TABLE `students_exams` (
  ...
  CONSTRAINT `students_exams_ibfk_1` FOREIGN KEY (`id_exam`) REFERENCES `exams` (`id`),
  CONSTRAINT `students_exams_ibfk_2` FOREIGN KEY (`id_student`) REFERENCES `students` (`id`)
